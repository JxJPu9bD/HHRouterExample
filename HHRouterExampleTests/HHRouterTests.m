...
//        [StoryboardInitViewController class]);

    StoryboardInitViewController* userViewController = (StoryboardInitViewController*)
	...
	StoryboardInitViewController* userViewController1 = (StoryboardInitViewController*)
	[[HHRouter shared] matchController:@"/test/7777777?aa=11&bb=22"];
	NSLog(@"%@", userViewController1.params);
	
	
	StoryboardInitViewController* userViewController2 = (StoryboardInitViewController*)
	[[HHRouter shared] matchController:@"/test/7777777"];
	NSLog(@"%@", userViewController2.params);
	
	StoryboardInitViewController* userViewController3 = (StoryboardInitViewController*)
	[[HHRouter shared] matchController:@"/test/7777777/?aa=11&bb=22"];
